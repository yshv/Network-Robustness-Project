...
def htd_network_design(graph, E, T_c, N_sub, alpha,length_limit,gamma,write = False):
    """
...
#     top = nt.Topology.Topology()
    ...
    if write == True:
        ...
        nt.Database.insert_graph(design_graph, "Topology_Data", "HTD-distance", node_data=True, use_pickle=True, 
...
if __name__ == "__main__":
    ...
    #     print(T_c)
        for i in range(topology_num):
            designed_graph,DWC_combined = htd_network_design(graph, E, T_c, N_sub, alpha,length_limit,gamma,write = True)
