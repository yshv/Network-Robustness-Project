...
if __name__ == "__main__":
    ...
    lambda_list = []
    for i in range(1,6):
        graph = nx.read_gpickle("/Users/yashvirsangha/Desktop/Third_Year_Project/TYP_Code/networktoolbox-master/scripts/Yashvir/BA_Data/{}({})-0_3.gpickle".format(nodes,i))
