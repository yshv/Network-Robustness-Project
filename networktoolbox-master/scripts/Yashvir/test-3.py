...
if __name__ == "__main__":
    ...
    for i in range(0, 14, 2):
        graph = nx.read_gpickle("/home/zceeysa/Desktop/TYP_Code/networktoolbox-master/scripts/Yashvir/ER_data/15(3)-{}_0.3.gpickle".format(i))
    ...
    with open("/home/zceeysa/Desktop/TYP_Code/networktoolbox-master/scripts/Yashvir/ER_data/ILP-results-3.txt", 'w') as f:
