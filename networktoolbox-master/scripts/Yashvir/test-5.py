...
if __name__ == "__main__":
    ...
    lambda_list = []
    for p in p_list:
        graph = nx.read_gpickle("/home/zceeysa/Desktop/TYP_Code/networktoolbox-master/scripts/Yashvir/Data/graph_{}-5_{}.gpickle".format(nodes,p))
    ...
    with open("/home/zceeysa/Desktop/TYP_Code/networktoolbox-master/scripts/Yashvir/Data/ILP-results-5.txt", 'w') as f:
