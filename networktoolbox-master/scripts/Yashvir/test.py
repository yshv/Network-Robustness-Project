...
if __name__ == "__main__":
    ...
    lambda_list = []
    for p in p_list:
        graph = nx.read_gpickle("/Users/yashvirsangha/Desktop/Third_Year_Project/Code_Robin/networktoolbox-master/scripts/Yashvir/Data/graph_{}-1_{}.gpickle".format(nodes,p))
    ...
    with open("/Users/yashvirsangha/Desktop/Third_Year_Project/Code_Robin/networktoolbox-master/scripts/Yashvir/Data/ILP-1-results.txt", 'w') as f:
