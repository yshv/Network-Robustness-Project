...
if __name__ == "__main__":
    ...
    for p in p_list:
        ...
        data = network.rwa.static_ILP(min_wave=True, max_time=60, e=20, k=20, threads=80,
    ...
    with open("../TYP_code/networktoolbox-master/scripts/Yashvir/Data/ILP-results.txt", 'w') as f:
