...
if __name__ == "__main__":
    ...
    lambda_list = []
    for p in p_list:
        graph = nx.read_gpickle("/home/zceeysa/TYP_Code/networktoolbox/scripts/Yashvir/Data/graph_{}_{}.gpickle".format(nodes,p))
    ...
    with open("/home/zcceysa/TYP_Code/networktoolbox/scripts/Yashvir/Data/ILP-results.txt", 'w') as f:
