...
def test(nodes, rmv):
    ...
    lambda_list = []
    for p in p_list:
        graph = nx.read_gpickle("networktoolbox-master/scripts/Yashvir/Data/graph_{}-{}_{}.gpickle".format(nodes,rmv,p))
    ...
    with open("/home/zceeysa/Desktop/TYP_Code/networktoolbox-master/scripts/Yashvir/Data/ILP-{}-{}.txt".format(nodes,rmv), 'w') as f:
