...
if __name__ == "__main__":
    ...
    for i in range(0, 14, 2):
        graph = nx.read_gpickle("networktoolbox-master/scripts/Yashvir/ER_data/15(1)-{}_0.3.gpickle".format(i))
    ...
    with open("networktoolbox-master/scripts/Yashvir/ER_data/ILP-results-1.txt", 'w') as f:
