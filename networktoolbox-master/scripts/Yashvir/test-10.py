...
if __name__ == "__main__":
    ...
    for i in range(0, 14, 2):
        graph = nx.read_gpickle("/home/zceeysa/Desktop/TYP_Code/networktoolbox-master/scripts/Yashvir/BA_data/15(4)-{}_3.gpickle".format(i))
    ...
    with open("/home/zceeysa/Desktop/TYP_Code/networktoolbox-master/scripts/Yashvir/BA_data/ILP-results-4.txt", 'w') as f:
