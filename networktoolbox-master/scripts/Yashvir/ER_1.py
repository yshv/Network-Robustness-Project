...
if __name__ == "__main__":
    ...
    for i in range(0, 14, 2):
        graph = nx.read_gpickle("/home/zceeysa/Desktop/TYP_Code/networktoolbox-master/scripts/Yashvir/15_36_ER_data/36(1)-{}_0.342.gpickle".format(i))
    ...
    with open("/home/zceeysa/Desktop/TYP_Code/networktoolbox-master/scripts/Yashvir/15_36_ER_data/ILP-results-1.txt", 'w') as f:
