...
if __name__ == "__main__":
    ...
    for i in range(0, 14, 2):
        graph = nx.read_gpickle("networktoolbox-master/scripts/Yashvir/BA_data/15(5)-{}_3.gpickle".format(i))
    ...
    with open("networktoolbox-master/scripts/Yashvir/BA_data/ILP-results-5.txt", 'w') as f:
